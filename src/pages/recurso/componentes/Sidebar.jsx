        ...
        <div className="flex-1 bg-[#0d30a1] p-4 rounded-tr-[100px] flex flex-col justify-between">
          <nav className="flex flex-col gap-6">
            ...
            <div className="relative">
              <button
                className="flex items-center gap-4 text-white py-2 px-4 rounded-xl hover:bg-primary-900/50 transition-colors text-lg font-medium data-dropdown"
            ...
            <div className="relative">
              ...
              >
                <li className="p-4 hover:bg-hover-elements text-white text-lg">
                  <a href="/Menu_calendar">Todos los Eventos</a>
                </li>
              </ul>
            </div>
            ...
            <div className="relative">
              <button
                className="flex items-center gap-4 text-white py-2 px-4 rounded-xl hover:bg-primary-900/50 transition-colors text-lg font-medium data-dropdown"
                onClick={() => toggleSubmenu(setShowInformeSubmenu, [setShowProjectsSubmenu, setShowTasksSubmenu, setShowCalendarSubmenu])}
              >
                <FiFileText />
                <span>Informe</span>
                <svg
                  className={`w-4 h-4 ml-2 transition-transform ${showInformeSubmenu ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <ul
                className={`overflow-hidden ml-4 border-l border-green-500 ${showInformeSubmenu ? '' : 'hidden'}`}
              >
                <li className="p-4 hover:bg-hover-elements text-white text-lg">
