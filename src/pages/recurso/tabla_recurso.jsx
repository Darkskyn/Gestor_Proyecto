...
const Dash = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 grid grid-cols-1 lg:grid-cols-4 xl:grid-cols-6">
      <Sidebar />
      ...
      <main className="lg:col-span-3 xl:col-span-5 p-8">
        ...
        <div className="flex justify-end pt-10">
          <Link to={`/ms_proyect/crear_Proyect?projectId=${idproyect}&projectName=${encodeURIComponent(nombre_proyecto)}`} className="flex items-center bg-gradient-to-r from-[#0d17a1] to-[#00ff04d7] border border-fuchsia-00 hover:border-violet-100 text-white font-semibold py-3 px-6 rounded-md transition-colors duration-300">
            <svg className="w-5 h-5 mr-2 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
            </svg>
            Siguiente
