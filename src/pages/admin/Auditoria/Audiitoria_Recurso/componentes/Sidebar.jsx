...
console.error('Error al obtener los datos:', error);
  ...
  const handleRedirect = () => {
    history.push('/Admin_Proyecto'); // Redirige a la ruta /Admin_Proyecto al hacer clic en el botón
  };

  return (
    <>
      <div
        className={`bg-[#0d30a1d0] h-full fixed lg:static w-[80%] md:w-[40%] lg:w-full transition-all z-50 duration-300 ${
